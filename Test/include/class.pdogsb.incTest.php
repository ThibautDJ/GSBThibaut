...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2021-05-16 at 17:55:44.
 */
class PdoGsbTest extends PHPUnit_Framework_TestCase {
    ...
    /**
     * @covers PdoGsb::refuserFraisHorsForfait
     * @todo   Implement testRefuserFraisHorsForfait().
     */
    public function testRefuserFraisHorsForfait() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
    ...
    /**
     * @covers PdoGsb::getMontantTotal
     * @todo   Implement testGetMontantTotal().
     */
    ...
    /**
     * @covers PdoGsb::majFicheFraisMontant
     * @todo   Implement testMajFicheFraisMontant().
     */
    public function testMajFicheFraisMontant() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
    ...
    /**
     * @covers PdoGsb::getLesFicheFrais
     * @todo   Implement testGetLesFicheFrais().
     */
    public function testGetLesFicheFrais() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
    ...
    /**
     * @covers PdoGsb::remboursement
     * @todo   Implement testRemboursement().
     */
    public function testRemboursement() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
                'This test has not been implemented yet.'
        );
